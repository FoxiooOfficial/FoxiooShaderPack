...
### ⚠️ Note
- The description was last updated on **January 4, 2026 (CET)**.
- The update of shaders was last updated on **January 4, 2026 (CET)**.
...
|-----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----|
| Background                              | These shaders use the object texture and the background texture for calculations **OR** only background texture.                     | 201 |
| Switch                                  | These shaders use either the object texture **OR** the background texture depending on the setting of the `_Blending_Mode` variable. | 114 |
| Texture                                 | These shaders use **ONLY** the object texture or external texture                                                                    | 33  |
...
| Windows (Direct3D 9)                | ✅        | *Some advanced effects are not the same as other ports due to Pixel Shader 2 limitations.*                                                                                                                                                  |
| Windows (Direct3D 11)               | ✅        | -                                                                                                                                                                                                                                            |
