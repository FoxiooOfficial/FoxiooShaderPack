...
|-------------------------------------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Windows (Direct3D 8)                | 🟨        | *I found a way to make shaders work under Direct3D8, but without additional variables and textures. I will continue experimenting to achieve full compatibility (as long as these shaders are separate from .fx, where Direct3D9 also works).* |
