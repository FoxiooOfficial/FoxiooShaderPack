...
{
    _Result[0] = 1 - (_Base[0] && _Blend[0]);
    _Result[1] = 1 - (_Base[1] && _Blend[1]);
    _Result[2] = 1 - (_Base[2] && _Blend[2]);
    _Result[3] = 1 - (_Base[3] && _Blend[3]);
    _Result[4] = 1 - (_Base[4] && _Blend[4]);
    _Result[5] = 1 - (_Base[5] && _Blend[5]);
    _Result[6] = 1 - (_Base[6] && _Blend[6]);
    _Result[7] = 1 - (_Base[7] && _Blend[7]);
}
