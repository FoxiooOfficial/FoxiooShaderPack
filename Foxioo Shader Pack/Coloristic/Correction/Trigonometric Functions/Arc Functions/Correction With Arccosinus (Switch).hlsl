    ...
    float4 _Render_Background = S2D_Background.Sample(S2D_BackgroundSampler, In.texCoord);
        ...
        if(_Blending_Mode == 0)
        {
            switch (_Render_Switch)
            {
                case 0: // Acos mode from Direct3D11
                        _Result = acos(_Render_Texture * _Mul);
                    break;

                case 1: // Acos mode SYMULATED from Direct3D9
                        _Result = abs(Fun_Acos(_Render_Texture * _Mul));
                    break;

                case 2: // Acos mode SYMULATED from Direct3D11
                        _Result = Fun_Acos(_Render_Texture * _Mul);
                    break;
            };
        ...
        else
        {
            switch (_Render_Switch)
            {
                ...
                case 1: // Acos mode SYMULATED from Direct3D9
                        _Result = abs(Fun_Acos(_Render_Background * _Mul));
                    break;

                case 2: // Acos mode SYMULATED from Direct3D11
                        _Result = Fun_Acos(_Render_Background * _Mul);
                    break;
            };
