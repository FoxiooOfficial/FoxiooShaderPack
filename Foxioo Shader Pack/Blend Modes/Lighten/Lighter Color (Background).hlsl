...
PS_OUTPUT ps_main( in PS_INPUT In )
{
    ...
    float4 _Render_Background = S2D_Background.Sample(S2D_BackgroundSampler, In.texCoord) * _Mixing;
        ...
        float _Average = (_Render_Texture.r + _Render_Texture.g + _Render_Texture.b) / 3.0;
            if (_Render_Background.r > _Average) { _Result.r = _Render_Background.r; }
            if (_Render_Background.g > _Average) { _Result.g = _Render_Background.g; }
            if (_Render_Background.b > _Average) { _Result.b = _Render_Background.b; }
