...
PS_OUTPUT ps_main(in PS_INPUT In)
{
    ...
    float4 _Render_Texture;
        _Render_Texture.a = S2D_Image.Sample(S2D_ImageSampler, frac(_UV * _Scale * float2(_ScaleX, _ScaleY) + float2(_PosX, _PosY))).a * In.Tint.a;
        _Render_Texture.rgb = _Color.rgb;
