...
float4 Main(in PS_INPUT In, bool _Premultiplied) : SV_TARGET
{
    ...
    float4 _Render_Background = S2D_Background.Sample(S2D_BackgroundSampler, In.bgCoord);
        ...
        float4 _Result = _Blending_Mode ? Fun_AA(S2D_Background, S2D_BackgroundSampler, In.bgCoord, _Render_Background, _Render_Texture.a) : Fun_AA(S2D_Image, S2D_ImageSampler, In.texCoord, _Render_Texture, 1.0) * In.Tint;
