...
static float4 _OverlayTop    = float4(0.41, 0.4, 0.44, 1.0);
static float4 _OverlayBottom = float4(0.4, 0.4, 0.42, 1.0);

static float3 _InnerLight     = float3(0.65, 0.64, 0.73);
static float3 _InnerShadow    = float3(0.96, 0.95, 0.97);
