...
float4 _OverlayTop    = float4(0.0, 0.28, 0.84, 1.0);
float4 _OverlayBottom = float4(0.0, 0.08, 0.57, 1.0);

float3 _InnerLight     = float3(0.25, 0.59, 1.0);
float3 _InnerShadow    = float3(0.0, 0.14, 0.63);
