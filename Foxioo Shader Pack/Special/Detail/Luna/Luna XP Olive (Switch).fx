...
float4 _OverlayTop    = float4(0.55, 0.6, 0.39, 1.0);
float4 _OverlayBottom = float4(0.35, 0.4, 0.29, 1.0);

float3 _InnerLight     = float3(0.91, 0.96, 0.75);
float3 _InnerShadow    = float3(0.55, 0.58, 0.43);
