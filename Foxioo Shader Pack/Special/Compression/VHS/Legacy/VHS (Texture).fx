...
float4 ps_main(in PS_INPUT In) : COLOR0
{
    ...
    //float4 _Render_Background = tex2D(S2D_Background, In.bgCoord);
        ...
        _Result.rgb = Fun_Sharp(S2D_Image, In.texCoord, _Render_Texture.rgb, 1.5);
            ...
            /* Ringing */
                float3 _Ringing = Fun_Ringing(S2D_Image, In.texCoord + _Rainbow_Pre.r * 0.05, _Result.rgb * _Rainbow);
