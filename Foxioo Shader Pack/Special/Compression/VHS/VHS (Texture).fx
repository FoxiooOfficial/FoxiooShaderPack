...
float4 ps_main(in float2 In : TEXCOORD0, in float2 In_Background : TEXCOORD1) : COLOR0 : COLOR0
{
    ...
    //float4 _Render_Background = tex2D(S2D_Background, In_Background);
        ...
        _Result.rgb = Fun_Sharp(S2D_Image, In, _Render_Texture.rgb, 1.5);
            ...
            /* Ringing */
                float3 _Ringing = Fun_Ringing(S2D_Image, In + _Rainbow_Pre.r * 0.05, _Result.rgb * _Rainbow);
