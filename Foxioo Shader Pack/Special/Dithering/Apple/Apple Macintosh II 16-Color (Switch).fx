...
{
    float3(0.99, 0.95, 0.23),
    float3(0.98, 0.37, 0.07),
    float3(0.85, 0.0, 0.01),
    float3(0.92, 0.0, 0.51),
    float3(0.25, 0.06, 0.64),
    float3(0.0, 0.1, 0.82),
    float3(0.11, 0.69, 0.9),
    float3(0.22, 0.73, 0.17),
    float3(0.08, 0.39, 0.09),
    float3(0.34, 0.15, 0.02),
    float3(0.56, 0.44, 0.22),
    float3(0.76, 0.76, 0.76),
    float3(0.51, 0.51, 0.51),
