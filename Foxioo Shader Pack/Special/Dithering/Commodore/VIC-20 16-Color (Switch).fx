...
{
    float3(0.62, 0.16, 0.15),
    float3(0.4, 0.82, 0.85),
    float3(0.55, 0.13, 0.62),
    float3(0.3, 0.69, 0.24),
    float3(0.23, 0.19, 0.68),
    float3(0.76, 0.83, 0.35),
    float3(0.62, 0.3, 0.09),
    float3(0.87, 0.55, 0.33),
    float3(0.81, 0.36, 0.33),
    float3(0.46, 0.89, 0.92),
    float3(0.73, 0.32, 0.8),
    float3(0.54, 0.94, 0.47),
    float3(0.49, 0.42, 0.93),
    float3(1.0, 1.0, 0.59),
    float3(0.0, 0.0, 0.0),
    float3(1.0, 1.0, 1.0),
};
