...
static const float3 _Palette[_Palette_Size] = 
{
    ...
    float3(0.47, 0.4, 0.1),
    float3(0.46, 0.0, 0.0),
    float3(0.56, 0.19, 0.61),
    float3(0.05, 0.24, 0.73),
    float3(0.22, 0.67, 0.74),
    float3(0.09, 0.43, 0.09),
    float3(0.38, 0.77, 0.44),
    float3(0.5, 0.91, 0.92),
    float3(0.35, 0.51, 0.95),
    float3(0.85, 0.52, 0.9),
    float3(0.77, 0.31, 0.32),
    float3(0.78, 0.72, 0.44),
