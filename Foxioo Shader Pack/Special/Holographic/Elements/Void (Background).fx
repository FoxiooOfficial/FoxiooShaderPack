...
float4 ps_main(in float2 In : TEXCOORD0, in float2 In_Background : TEXCOORD1) : COLOR0
{
    ...
    float4 _Render_Background = tex2D(S2D_Background, In_Background);
        ...
        _Space *= 0.5;
            ...
            float _Render_Background_Void_R = tex2D(S2D_Background, In_Background + (_Render_Background.r * (1.0 - _Render_Texture.r) + _Rand) * 0.1).r;
            float _Render_Background_Void_G = tex2D(S2D_Background, In_Background + (_Render_Background.g * (1.0 - _Render_Texture.g) + _Rand) * 0.1).b;
            float _Render_Background_Void_B = tex2D(S2D_Background, In_Background + (_Render_Background.b * (1.0 - _Render_Texture.b) + _Rand) * 0.1).b;
