...
**Instruction set for Pixel Shader** [(Source 1)](https://learn.microsoft.com/en-us/windows/win32/direct3dhlsl/dx9-graphics-reference-asm-ps-instructions-ps-1-x) [(Source 2)](https://web.archive.org/web/20120911164630/https://user.xmission.com/~legalize/book/download/13-Pixel%20Shaders.pdf)
...
| **Type** | **Instruction**        | **Description**                                                               | **Instruction slots** | ``ps1.0`` | ``ps1.1`` | ``ps1.2`` | ``ps1.3`` | ``ps1.4`` | **Note**                                                                                                                                                                                          |
...
|          |                        | ***Phase instructions***                                                      |                       |         |         |         |         |         |                                                                                                                                                                                                   |
| **Type** | **Phase instructions** | **Description**                                                               | **Instruction slots** | ``ps1.0`` | ``ps1.1`` | ``ps1.2`` | ``ps1.3`` | ``ps1.4`` | **Note**                                                                                                                                                                                          |
...
**Instruction set for Vertex Shader** [(Source)](https://learn.microsoft.com/en-us/windows/win32/direct3dhlsl/dx9-graphics-reference-asm-vs-instructions-vs-1-1)
